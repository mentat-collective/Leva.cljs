...
> **Note**
> This project was generated by the [`leva/clerk`
> template](https://github.com/mentat-collective/Leva.cljs/tree/main/resources/leva/clerk)
> from [`Leva.cljs`](https://leva.mentat.org).

This project allows you to interactively develop [Clerk][clerk-url] notebooks
using [`Leva.cljs`](https://leva.mentat.org) code inside of your project's
