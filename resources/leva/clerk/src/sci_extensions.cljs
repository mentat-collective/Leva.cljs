...
;; ## Leva.cljs installation
;;
;; This first section installs all `Leva.cljs` namespaces into the project:

(leva.sci/install!)

;; See [`Leva.cljs` via SCI](https://leva.mentat.org/#leva.cljs-via-sci) for
;; more details.
